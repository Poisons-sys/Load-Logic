  ...
  try {
    ...
    const [newProduct] = await db.insert(products)
      .values({
        ...
        maxTopLoadKg: maxTopLoadKg !== undefined ? maxTopLoadKg : 2500,
        allowRotate90: allowRotate90 !== undefined ? allowRotate90 : true,
        noStackAbove: noStackAbove !== undefined ? noStackAbove : false,
        floorOnly: floorOnly !== undefined ? floorOnly : false,
