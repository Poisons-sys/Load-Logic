  ...
  try {
    ...
    const [updatedProduct] = await db.update(products)
      .set({
        ...
        maxTopLoadKg: maxTopLoadKg !== undefined ? maxTopLoadKg : (existingProduct as any).maxTopLoadKg,
        allowRotate90: allowRotate90 !== undefined ? allowRotate90 : (existingProduct as any).allowRotate90,
        noStackAbove: noStackAbove !== undefined ? noStackAbove : (existingProduct as any).noStackAbove,
        floorOnly: floorOnly !== undefined ? floorOnly : (existingProduct as any).floorOnly,
